...
USBrelay.prototype.listPorts = function() {
...
USBrelay.prototype.findBoards = function() {
...
USBrelay.prototype.setStates = function(stateArray) {
...
USBrelay.prototype.toggleOne = function(relay, command) {
    if (!this.nBoards) return new Promise((resolve, reject) => reject(new Error(`No boards have been initialized`)));
    
    return this.boards[ Math.ceil(relay / 16) - 1 ].toggleOne((relay - 1) % 16 + 1, command);
}

USBrelay.prototype.toggle = function(toToggle, command) {
    if (!this.nBoards) return new Promise((resolve, reject) => reject(new Error(`No boards have been initialized`)));
...
USBrelay.prototype.reset = function() {
    if (!this.nBoards) return new Promise((resolve, reject) => reject(new Error(`No boards have been initialized`)));
