...
function RelayBoard({ port = null, test = false, name = null } = {}) {
...
RelayBoard.prototype.setState = function(stateArray) {
    return new Promise((resolve, reject) => {
...
RelayBoard.prototype.toggle = function(toToggle, command) {
    return new Promise((resolve, reject) => {
...
RelayBoard.prototype.reset = function() {
    return new Promise((resolve, reject) => {
